...
// Wed Oct 28 12:12:23 2020 by ROOT version 6.22/02
// from TTree T/Decay
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Particle;
   Float_t         DecayParticle_1;
   Float_t         E1;
   Float_t         px1;
   Float_t         py1;
   Float_t         pz1;
   Float_t         pt1;
   Float_t         DecayParticle_2;
   Float_t         E2;
   Float_t         px2;
   Float_t         py2;
   Float_t         pz2;
   ...
   // List of branches
   TBranch        *b_Particle;   //!
   TBranch        *b_DecayParticle_1;   //!
   TBranch        *b_E1;   //!
   TBranch        *b_px1;   //!
   TBranch        *b_py1;   //!
   TBranch        *b_pz1;   //!
   TBranch        *b_pt1;   //!
   TBranch        *b_DecayParticle_2;   //!
   TBranch        *b_E2;   //!
   TBranch        *b_px2;   //!
   TBranch        *b_py2;   //!
   TBranch        *b_pz2;   //!
...
void Analyzer::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("DecayParticle_1", &DecayParticle_1, &b_DecayParticle_1);
   ...
   fChain->SetBranchAddress("DecayParticle_2", &DecayParticle_2, &b_DecayParticle_2);
