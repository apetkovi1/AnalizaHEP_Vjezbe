...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void Chi_Square_Fit();
   virtual void ML_Fit();
   
   public:
   	TTree *tree;
   	TH1F* h1; //dodano
   	TH1* Histo19 = new TH1F("Signal", "Signal", 40, 110, 150);  
   	TH1* Histo20 = new TH1F("BKG", "BKG", 40, 110, 150);
	TH1* Histo21 = new TH1F("Signal1", "Signal1", 50, 70, 170);  
   	TH1* Histo22 = new TH1F("BKG1", "BKG1", 50, 70, 170);
};
