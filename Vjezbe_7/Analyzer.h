...
// Wed Nov  4 12:08:58 2020 by ROOT version 6.22/02
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void PlotHistogram(TString s);
   virtual void PlotHistogram_new();
   virtual void PlotHistogram_Discriminator();
   
   public:
   	TTree *tree;
   	TH1F* h1; //dodano
   	TH1* Histo19 = new TH1F("Signal", "Signal", 50, 70, 170); //deklariram ih kao public (a ne u funkciji PlotHistogram) zato sto cu ih koristit i u drugoj gunkciji (Plot_Histogram_new)
   	TH1* Histo20 = new TH1F("BKG", "BKG", 50, 70, 170);
	TH1* Histo21 = new TH1F("D1", "Kinematic_Discriminator", 100, 0, 1);
    TH1* Histo22 = new TH1F("KD2", "KD2", 100, 0, 1);
	TH2* Histo23 = new TH2F("Mass_KD_Signal","Mass_KD_Signal",50,70,170,20,0,1); //2D histogram
	TH2* Histo24 = new TH2F("Mass_KD_BKG","Mass_KD_BKG",50,70,170,20,0,1);
	TLegend* legend5 = new TLegend(0.75,0.75,0.9,0.9);
};
